    ...
    handle: {
      downloadRepo: {
        ...
        handle: async (
          ...
          const folderName = values.repoUrl
            .split("/")
            .pop()
            .replace(".git", "");
        ...
        handle: async (
          {
            values,
            ctx: {
              [runRepoCommands.runProject.handle.downloadRepo.name]: {
                path: repoPath,
              },
            },
          },
      ...
      runProject: {
        ...
        handle: async (
          {
            ctx: {
              [runRepoCommands.runProject.handle.downloadRepo.name]: { path },
            },
          },
          { launchCommand, launchBlock }
        ) => {
